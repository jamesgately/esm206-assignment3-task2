...
**Note: You should get a warning about one piece dropped. What happens to the name in Row 49, which contains two dashes? **A: The last part of the name -- after the second dash -- is no longer shown**.
...
some_dates <- c(11241859, 01131994, 11032020)
